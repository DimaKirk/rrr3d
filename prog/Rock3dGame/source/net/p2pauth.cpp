...
// Purpose: constructor
//-----------------------------------------------------------------------------
CP2PAuthPlayer::CP2PAuthPlayer( SteamService *pGameEngine, CNetworkTransport *pNetworkTransport )
...
uint64 CP2PAuthPlayer::GetGameTimeInSeconds()
{
	return m_pGameEngine->time();
}
...
// Purpose: constructor
//-----------------------------------------------------------------------------
CP2PAuthedGame::CP2PAuthedGame( SteamService *pGameEngine )
{
